package com.example.birthdaytree.adapterframe;
...
public class SwipeListView extends ListView {
	 ...
	 * move, return true
	 * 用于拦截手势事件,每个手势事件调用前都会调用它,返回值为真的话就会拦截手势,使手势无效
	 */
	@Override
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			mFirstX = lastX;
			mFirstY = lastY;
			int motionPosition = pointToPosition((int) mFirstX, (int) mFirstY);//通过坐标位置得知listView里面的item
