...
public class MyView extends ImageView {
	...
	public void init(){
		...
		leftAreaPaint.setAlpha(MyView.LEFT_AREA_ALPHA);
	}
	...
	private boolean isOutOfArea(int x,int y){
		switch(recFlag){
		case MyView.PRESS_LB:
			this.pressLB(x - mx, y - my);
			break;
		case MyView.PRESS_LT:
			this.pressLT(x - mx, y - my);
			break;
		case MyView.PRESS_RB:
			this.pressRB(x - mx, y - my);
			break;
		case MyView.PRESS_RT:
